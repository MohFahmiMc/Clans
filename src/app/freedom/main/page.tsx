...
export default function MainPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans relative overflow-x-hidden animate-in fade-in duration-500">
      
      {/* BACKGROUND IMAGE KUSTOM */}
      {bgImgSrc && (
        <div 
          className="fixed inset-0 bg-cover bg-center bg-no-repeat opacity-40 z-0 pointer-events-none transition-opacity duration-1000"
          style={{ backgroundImage: `url(${bgImgSrc})` }}
        />
      )}
      <div className="fixed inset-0 bg-gradient-to-b from-[#050505]/20 via-[#050505]/60 to-[#050505] z-0 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        <header className="pt-20 pb-12 md:pt-32 md:pb-16 text-center flex flex-col items-center animate-in slide-in-from-top-6 duration-700">
          <div className="max-w-4xl mx-auto w-full flex flex-col items-center">
            ...
            <h1 className="text-6xl md:text-9xl font-black tracking-tighter uppercase text-white mb-4 drop-shadow-[0_0_50px_rgba(234,88,12,0.55)] transition-all hover:scale-[1.01] duration-300 select-none">
              FREEDOM
            </h1>
            ...
            {/* BUTTON DISCORD DENGAN LOGO YANG SUDAH DIPERBAIKI */}
            <a 
              href="https://discord.gg/2veK4TDWtF" 
              target="_blank" 
              rel="noreferrer" 
              className="flex items-center justify-center gap-3 w-full sm:w-auto px-8 py-4 bg-[#5865F2] hover:bg-[#4752C4] text-white font-extrabold rounded-xl shadow-[0_4px_25px_rgba(88,101,242,0.4)] hover:shadow-[0_4px_35px_rgba(88,101,242,0.6)] transition-all duration-300 uppercase tracking-widest text-xs md:text-sm transform hover:-translate-y-0.5 active:translate-y-0"
            >
        ...
        {/* ======================================================== */}
        {/* CHARACTER SHOWCASE CARD - 2D HEAD CROP EMBED STYLE */}
        {/* ======================================================== */}
        {leaderMember && (
          <section className="pb-20 w-full flex flex-col items-center animate-in slide-in-from-bottom-8 duration-700 delay-150">
            <div 
              onClick={() => setSelectedMember(leaderMember)}
              className="bg-[#1e1f22] border border-white/5 border-l-4 border-red-500 p-6 rounded-r-2xl flex items-center justify-between gap-6 w-full max-w-md shadow-[0_15px_40px_rgba(0,0,0,0.6)] group hover:border-white/10 hover:shadow-[0_20px_50px_rgba(239,68,68,0.15)] transition-all duration-300 cursor-pointer transform hover:-translate-y-1"
              title="Klik untuk membuka Detail 3D Roster Profil Leader"
            >
              {/* Sisi Kiri: Informasi Identitas */}
              <div className="flex flex-col min-w-0">
                <span className="text-[9px] font-black text-red-400 uppercase tracking-widest border border-red-500/20 bg-red-500/5 px-2.5 py-0.5 rounded-md w-fit mb-2">
                  Clan Leader
                </span>
                <h3 className="text-xl font-black text-white uppercase tracking-wider font-mono truncate group-hover:text-red-400 transition-colors">
                  {leaderMember.name}
                </h3>
                <p className="text-xs text-slate-400 mt-1 italic line-clamp-2">
                  {leaderMember.description || "Player ini memegang kendali tertinggi dalam struktur komando Freedom Clan."}
                </p>
                <span className="text-[9px] uppercase font-bold tracking-widest text-slate-500 mt-3 group-hover:text-white transition-colors flex items-center gap-1">
                  ✦ Click to View 3D Profile ✦
                </span>
              </div>

              {/* Sisi Kanan: Ekstraksi Kepala Kepala 2D (SpongeBob/Minecraft pixelated look) */}
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-[#151515] border-4 border-[#1e1f22] overflow-hidden shadow-2xl group-hover:border-red-500/50 transition-colors flex-shrink-0 relative">
        ...
        {/* ======================================================== */}
        {/* 2. SERVER INFO DENGAN DEFAULT PORT MINECRAFT */}
        {/* ======================================================== */}
        <section id="server" className="py-16 md:py-24 border-y border-white/5 bg-black/40 backdrop-blur-md rounded-2xl mb-16 animate-in fade-in duration-1000">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <img src={mcProwSrc} alt="Minecraft ProwNetwork" className="w-full max-w-[250px] md:max-w-[400px] mx-auto object-contain mb-12 drop-shadow-[0_15px_30px_rgba(0,0,0,0.8)] transform hover:scale-[1.02] transition-transform duration-300" />
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              
              {/* SERVER JAVA EDITION */}
              <div className="bg-[#0f0f0f]/90 border border-white/5 p-8 rounded-xl flex flex-col items-center justify-center group hover:border-orange-500/50 hover:bg-orange-500/[0.02] transition-all duration-300 shadow-xl">
                <svg className="w-8 h-8 text-orange-500 mb-4 transform group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-2">Java Edition Server (PC)</span>
                <span className="text-xl md:text-2xl font-black text-white tracking-wider group-hover:text-orange-400 transition-colors select-all">
                  play.prownetwork.net
                </span>
                <span className="text-[11px] font-bold font-mono text-slate-500 mt-2 bg-black px-2.5 py-0.5 border border-white/5 rounded">
                  Port: <span className="text-orange-400">25565</span>
                </span>
              </div>
              
              {/* SERVER BEDROCK EDITION */}
              <div className="bg-[#0f0f0f]/90 border border-white/5 p-8 rounded-xl flex flex-col items-center justify-center group hover:border-[#5865F2]/50 hover:bg-[#5865F2]/[0.02] transition-all duration-300 shadow-xl">
                <svg className="w-8 h-8 text-[#5865F2] mb-4 transform group-hover:scale-110 transition-transform fill-current" viewBox="0 0 24 24">
                ...
                <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-2">Bedrock Edition (PE/Mobile/Console)</span>
                <span className="text-xl md:text-2xl font-black text-white tracking-wider group-hover:text-[#5865F2] transition-colors select-all">
                  be.prownetwork.net
                </span>
                <span className="text-[11px] font-bold font-mono text-slate-500 mt-2 bg-black px-2.5 py-0.5 border border-white/5 rounded">
                  Port: <span className="text-[#5865F2]">19132</span>
                </span>
              </div>
        ...
        {/* 3. STATS GRID */}
        {/* ======================================================== */}
        <section className="py-12 px-4 w-full border-b border-white/5 bg-black/10 backdrop-blur-sm rounded-xl mb-16 animate-in slide-in-from-bottom-4 duration-1000">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={i} className="text-center p-6 bg-[#0f0f0f]/80 border border-white/5 rounded-xl hover:border-orange-500/30 transition-all duration-300 shadow-lg transform hover:-translate-y-0.5">
                  {stat.icon}
        ...
        {/* ======================================================== */}
        {/* 4. PREMIUM RATING CHAT SYSTEM */}
        {/* ======================================================== */}
        <section className="py-12 px-4 w-full max-w-5xl mx-auto relative bg-[#0a0a0b]/60 border border-white/5 rounded-2xl backdrop-blur-md p-6 md:p-8 animate-in fade-in duration-1000 shadow-2xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-white/5 pb-6 mb-8 gap-4">
            ...
            <div className="flex items-center gap-4 bg-neutral-900/60 border border-white/10 px-5 py-3 rounded-xl backdrop-blur-md shadow-inner">
          ...
          <div className="bg-black/40 border border-white/5 p-8 rounded-2xl flex flex-col items-center text-center max-w-xl mx-auto mb-12 shadow-inner">
      ...
      {/* ======================================================== */}
      {/* JENDELA POPUP MODAL PROFILE INTERACTIVE (MEMUAT MODEL 3D) */}
      {/* ======================================================== */}
      {selectedMember && (
        <Profile 
