...
export default function MainPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans relative overflow-x-hidden">
      ...
      {bgImgSrc && (
        <div 
          className="absolute inset-0 bg-cover bg-center opacity-20 z-0 pointer-events-none mix-blend-lighten"
          style={{ backgroundImage: `url(${bgImgSrc})` }}
        />
      )}
      <div className="absolute inset-0 bg-gradient-to-b from-[#050505]/40 via-[#050505]/95 to-[#050505] z-0 pointer-events-none" />
