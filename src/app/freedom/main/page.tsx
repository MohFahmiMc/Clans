  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans relative overflow-x-hidden scroll-smooth transition-all duration-500">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pb-20">
        ...
        {/* ======================================================== */}
        <section id="server" className="py-12 border-y border-white/5 bg-black/40 backdrop-blur-md rounded-2xl mb-16 animate-in fade-in slide-in-from-bottom-6 duration-700">
        ...
        {/* CLAN STATS GRID */}
        {/* ======================================================== */}
        <section className="mb-16 animate-in fade-in slide-in-from-bottom-6 duration-700">
