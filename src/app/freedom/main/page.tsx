...
// COMPONENT ANIMASI SCROLL REVEAL
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans relative overflow-x-hidden scroll-smooth transition-all duration-500">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pb-20">
        ...
        {/* ======================================================== */}
        <ScrollReveal>
          <header className="pt-20 pb-12 md:pt-32 md:pb-16 text-center flex flex-col items-center">
          ...
          <ScrollReveal>
            <section className="pb-16 w-full flex flex-col items-center">
              <div 
                ...
                title="Klik untuk membuka Detail Profile Leader"
              >
        ...
        {/* ======================================================== */}
        <ScrollReveal>
          <section id="server" className="py-12 border-y border-white/5 bg-black/40 backdrop-blur-md rounded-2xl mb-16">
